@if ($paginator->hasPages())
    <nav>
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link ion-ios-arrow-back" href="{{ $paginator->previousPageUrl() }}" rel="prev"
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <a class="page-link ion-ios-arrow-forward" href="{{ $paginator->nextPageUrl() }}" rel="next"
