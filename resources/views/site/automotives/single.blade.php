            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single">{{ $automotive->number }} {{ Str::words($automotive->street, 1, '') }}
                        </h1>
                        <span
                            class="color-text-a">{{ Str::words(Str::of($automotive->street)->after(Str::words($automotive->street, 1, ''))) }},
                            {{ $automotive->state }}</span>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4">
                    <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('automotives') }}">Automóveis</a>
                            </li>
                            ...
                            <div class="property-price d-flex justify-content-center foo">
                                <div class="card-header-c d-flex">
                                    ...
                                    <div class="card-title-c align-self-center">
                                        <h5 class="title-c">
                                            {{ Str::words(Str::of($automotive->sale_price)->after(Str::words($automotive->sale_price, 1, ''))) }}
                                        </h5>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="summary-list">
                                    <ul class="list">
                                        <li class="d-flex justify-content-between">
                                            <strong>Automóvel ID:</strong>
                                            <span>{{ $automotive->id }}</span>
                                        </li>
                                        <li class="d-flex justify-content-between">
                                            <strong>Categoria</strong>
                                            <span>{{ $automotive->category }}</span>
                                        </li>
                                        <li class="d-flex justify-content-between">
                                            <strong>Marca:</strong>
                                            <span>{{ $automotive->brand }}</span>
                                        </li>
                                        <li class="d-flex justify-content-between">
                                            <strong>Modelo:</strong>
                                            <span>{{ $automotive->model }}</span>
                                        </li>
                                        <li class="d-flex justify-content-between">
                                            <strong>Ano:</strong>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="title-box-d">
                                        <h3 class="title-d">Descrição do Automóvel</h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form class="form-a contactForm" action="{{ route('sendEmail') }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="subject"
                                            value="Interesse pelo automóvel ID {{ $automotive->id }}">
                                        <div class="col-md-12 mb-1">
                                            <div class="form-group">
